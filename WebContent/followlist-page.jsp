...
<body>
	...
	<%
		List<User> followList = (List<User>) request.getAttribute("followList");
	%>
	...
	<% Integer curPage = (Integer)request.getAttribute("curPage");
        ...
        %>
	<a href="FollowList?curPage=1">首页</a>
	<a href="FollowList?curPage=<%=curPage - 1%>">上一页</a>
	<a href="FollowList?curPage=<%=curPage + 1%>">下一页</a>
	<a href="FollowList?curPage=<%=pageCount%>">尾页</a> 第<%=curPage%>页/共<%=pageCount%>页
