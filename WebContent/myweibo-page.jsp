...
<body>
	...
	<div id="container">
		...
		%>
		<a href="MyWeibo?curPage=1">首页</a> <a
			href="MyWeibo?curPage=<%=curPage - 1%>">上一页</a> <a
			href="MyWeibo?curPage=<%=curPage + 1%>">下一页</a> <a
			href="MyWeibo?curPage=<%=pageCount%>">尾页</a> 第<%=curPage%>页/共<%=pageCount%>页
