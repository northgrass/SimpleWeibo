...
<body>
	...
	%>
	<a href="SearchList?curPage=1&searchname=<%=searchname%>">首页</a>
	<a
		href="SearchList?curPage=<%=curPage - 1%>&searchname=<%=searchname%>">上一页</a>
	<a
		href="SearchList?curPage=<%=curPage + 1%>&searchname=<%=searchname%>">下一页</a>
	<a href="SearchList?curPage=<%=pageCount%>&searchname=<%=searchname%>">尾页</a>
